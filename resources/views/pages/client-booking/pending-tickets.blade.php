                                    ...
                                    @foreach($booking_data as $key =>$value)
                                        <tr>
                                            ...
                                            <td class="text-center"><a
                                                    href="{{url('view-tickets')}}/{{$value->InvoiceNo}}"><strong>{{$value->InvoiceNo}}</strong></a>
                                            </td>
                                            ...
                                            <td class="text-center fw-bolder text-muted fs-5">
                                                    ...
                                                    $total_cost = $ticket_cost ?
                                                        ...
                                                        $amount_recieved->BankAmount +
                                                        $amount_recieved->CashAmount +
                                                        $amount_recieved->OtherAmount +
                                                        $amount_recieved->CardAmount : 0;
