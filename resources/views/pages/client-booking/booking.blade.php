...
@section('content')
    <script src="https://cdn.tiny.cloud/1/8ocium3ymud15bb8sswaevn9jxk0jo821fjmyfwj7yml17bw/tinymce/6/tinymce.min.js"
                        ...
                        <form name="add_name" id="add_name" action="{{ url('addMorePost') }}" method="post">
                            <div class="row">
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                    ...
                                    <input type="text" readonly class="form-control" name="InvoiceNo" id="InvoiceNo"
                                           value="{{$newInvoice}}">
                                </div>
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                ...
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                    ...
                                    <input type="number" class="form-control" id="CustomerPostCode"
                                           name="CustomerPostCode" placeholder="Enter Customer PostCode">
                                </div>
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                    <label for="AirlineConfirmation" class="form-label">Airline Confirmation</label>
                                    <input type="text" class="form-control" id="AirlineConfirmation"
                                           name="AirlineConfirmation" placeholder="Enter Airline Confirmation">
                                </div>
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                    <label for="SupplierAgent" class="form-label">Supplier Agent</label>
                                    <input type="text" class="form-control" id="SupplierAgent" name="SupplierAgent"
                                           placeholder="Enter Supplier Agent">
                                </div>
                                <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                    <label for="SupplierRef" class="form-label">Supplier Ref</label>
                                    <input type="text" class="form-control" id="SupplierRef" name="SupplierRef"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                            ...
                                            <input type="text" class="form-control" id="DepartureAirport"
                                                   name="DepartureAirport" placeholder="Enter Departure Airport">
                                        </div>
                                        <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                            <label for="DestinationAirport" class="form-label">Destination
                                                Airport</label>
                                            <input type="text" class="form-control" id="DestinationAirport"
                                                   name="DestinationAirport" placeholder="Enter Destination Airport">
                                        </div>
                                        <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                            <label for="DepartureDate" class="form-label">Via</label>
                                            <input type="text" class="form-control" id="FlightVia" name="FlightVia"
                                        ...
                                        <div class="mb-3 col-lg-3 col-sm-12 col-md-12 col-xl-3">
                                            ...
                                            <input type="text" class="form-control" name="FlightPNR"
                                ...
                                <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                                            ...
                                            <textarea id="bookingNote" class="form-control"
                                                      name="BookingNote"></textarea>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12">
                                                    <label for="formrow-inputCity" class="form-label">Paying By <b
                                                            class="text-danger font-size-15">*</b></label>
                                                ...
                                                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12">
                                                    <label for="formrow-inputCity" class="form-label">Recipt Mode <b
                                                            class="text-danger font-size-15">*</b></label>
                                                ...
                                                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12">
                                                    <label for="formrow-inputCity" class="form-label">Payment Due Date
                                                        <b class="text-danger font-size-15">*</b></label>
                                            ...
                                            <div id="card-info" class="mt-3" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12">
                                                        <label for="formrow-inputCity" class="form-label">Card Holder
                                                            Name <b class="text-danger font-size-15">*</b></label>
                                                        <input type="text" class="form-control" name="CardHolderName">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12">
                                                        <label for="formrow-inputCity" class="form-label">Card No <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="text" class="form-control" name="CardNo">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12">
                                                        <label for="formrow-inputCity" class="form-label">Expiry Date <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-12">
                                                        <label for="formrow-inputCity" class="form-label">Security No.
                                                            <b class="text-danger font-size-15">*</b></label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-header"><h5>Ticket Cost: <b class="text-success"> 0.00</b></h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">Basic <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="BasicAmount" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">Tax <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="TaxAmount" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">APC <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="APCAmount" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">SAFI <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="SAFIAmount" placeholder="0.00">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="border-left col-md-6 col-lg-6 col-xl-6 col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">Bank Fee <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="BankFee" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">Card Fee <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="CardFee" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">APC Payable <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="APCPayable" placeholder="0.00">
                                                    </div>
                                                    <div class="col-md-3 col-lg-3 col-xl-3 col-sm-3">
                                                        <label for="formrow-inputCity" class="form-label">Misc <b
                                                                class="text-danger font-size-15">*</b></label>
                                                        <input type="number" min="0" step="1" class="form-control"
                                                               name="Misc" placeholder="0.00">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dynamic_field">
                                    ...
                                    <tr id="row" class="dynamic-added">
                                        ...
                                        <td>
                                            <input type="number" class="form-control" name="SeatQty[]"
                                                   placeholder="Quantity" required>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <div class="input-group-text"><b>£</b></div>
                                                <input type="number" class="form-control" name="SeatPrice[]"
                                                       placeholder="Seat Price" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <div class="input-group-text"><b>£</b></div>
                                                <input type="number" class="form-control" name="BookingFee[]"
                                                       placeholder="Booking Fee" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group">
